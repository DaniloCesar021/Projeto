...
<body>
    ...
    <div class="container col-sm-12">
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <p id="nome_autopeca">Guigo Autopeças</p>
                <img id="img_autopeca" src="../imagens/autopecas_guigo.jpeg" class="img-thumbnail" alt="Guigo Autopeças"
                    style="width: 100%;">

                <!-- Descrição abaixo da imagem -->
                <h6 id="titulo_descricao">Descrição</h6>
                <p id="p_descricao">A Guigo Autopeças é uma loja especializada na venda de peças automotivas de alta
                    qualidade, oferecendo soluções para veículos de diversas marcas e modelos. Com uma equipe de
                    especialistas no setor, a Guigo Autopeças se destaca pelo atendimento ágil e eficiente, sempre
                    focada em garantir a satisfação do cliente. Além de uma ampla variedade de produtos, a empresa
                    trabalha com marcas renomadas, garantindo a durabilidade e o bom desempenho das peças. Seja para
                    manutenção preventiva ou corretiva, a Guigo Autopeças é a parceira ideal para quem busca confiança e
                    economia no cuidado com o carro.</p>
            </div>
            ...
            <div id="card_local" class="col-12 col-md-6 mt-md-5 mb-sm-5">
                <div class="card mb-3 mt-md-5" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <p class="card-text">Av. Cipriano Barata, 100 - Anchieta, Rio de Janeiro - RJ, 21620-190</p>
                        ...
                        <p class="card-text">(21) 3339-7261</p>
                    </div>
                </div>
    ...
    <div id="mapa" class="container-fluid">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3677.1339721875393!2d-43.4113201!3d-22.8345324!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x996162382f6371%3A0x4b26abb371380291!2sGuigo%20Auto%20Pe%C3%A7as!5e0!3m2!1spt-BR!2sbr!4v1728508034471!5m2!1spt-BR!2sbr"
