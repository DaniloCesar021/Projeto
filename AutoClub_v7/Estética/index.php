...
<head>
    ...
    <link rel="stylesheet" href="../css/indexEstetica.css">
...
<body>
    ...
    <form class="container-sm d-flex justify-content-center" role="search">
        <input id="pesquisa" class="form-control form-control-sm me-2" type="search" placeholder="Pesquise na AutoClub" aria-label="Search">
    </form>

    <div class="container">
        <div class="row">
            <!-- O botão só aparecerá em larguras menores que md (768px) -->
            <button id="botao_filtro" class="btn btn-primary d-md-none d-block mt-3" type="button" data-bs-toggle="offcanvas"
                ...
                <div class="offcanvas-body">
                    <form>
                        ...
                        <div id="checkbox" class="form-check">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">Higienização</label>
                        </div>
    
                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Polimentos</label>
                        </div>
    
                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Vitrificação</label>
                        </div>
    
                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Lavagem Detalhada</label>
                        </div>
    
                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Limpeza de Motor</label>
                        </div>
    
                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Enceramento Técnico</label>
                        </div>
    
                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Insufilm</label>
                        </div>
                        
                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Limpeza de Chassi</label>
                        </div>
                        
                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Remoção de Chuva Ácida</label>
                        </div>
                        
                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Descontaminação</label>
                        </div><br><br>
    
                        <h6>Localização:</>
                        <select class="form-select" aria-label="Default select example" style="margin: 0;">
                            <option selected>Selecione uma região</option>
                            <option value="1">Vila Valqueire</option>
                            <option value="2">Nilópolis</option>
                            <option value="3">São João de Meriti</option>
                        </select><br>
    ...
    <div class="container">
        <div class="row">
            ...
            <div id="cards" class="col-md-9 d-flex flex-column align-items-center">
                <a class="text-decoration-none w-100" href="estetica_alfa.php">
                    <div class="card mb-3 mt-5 w-100">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="../imagens/estetica_alfa.jpeg" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Alfa Estética Automotiva</h5>
                                    <p class="card-text"> </p>
                ...
                <a class="text-decoration-none w-100" href="estetica_washplus.php">
                    <div class="card mb-3 w-100">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="../imagens/estetica_washplus.jpeg" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Washplus Estética Automotiva</h5>
                                    <p class="card-text"> </p>
                ...
                <a class="text-decoration-none w-100" href="estetica_agape.php">
                    <div class="card mb-3 w-100">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="../imagens/estetica_agape.jpeg" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Ágape Estética Automotiva</h5>
                                    <p class="card-text"> </p>
                                    <button id="btn" type="button" class="btn btn-primary btn-sm mt-1" disabled>Polimento Técnico</button>
                                    <button id="btn" type="button" class="btn btn-primary btn-sm mt-1" disabled>Lavagem Técnica</button>
