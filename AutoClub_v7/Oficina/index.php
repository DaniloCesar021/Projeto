                ...
                <div class="offcanvas-body">
                    <form>
                        ...
                        <div id="checkbox" class="form-check">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">Borracharia</label>
                        </div>

                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Pintura</label>
                        </div>

                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Troca de Óleo</label>
                        </div>

                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Balanceamento</label>
                        </div>

                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Freios</label>
                        </div>

                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Suspensão</label>
                        </div>

                        <div id="checkbox" class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">Troca de Bateria</label>
                        </div><br><br>
    ...
    <div class="container">
        <div class="row">
            ...
            <div id="cards" class="col-md-9 d-flex flex-column align-items-center">
                <a class="text-decoration-none w-100" href="oficina_autoGiro.php">
                    <div class="card mb-3 mt-5 w-100">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="../imagens/auto_giro.jpg" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Mecânica Auto Giro</h5>
                                    <p class="card-text"> </p>
                                    ...
                                    <button id="btn" type="button" class="btn btn-primary btn-sm mt-1" disabled>Reparo de Suspensão e
                                        Direção</button>
                ...
                <a class="text-decoration-none w-100" href="oficina_autoHope.php">
                    <div class="card mb-3 w-100">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="../imagens/auto_hope.jpeg" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Auto Hope</h5>
                                    <p class="card-text"> </p>
                ...
                <a class="text-decoration-none w-100" href="oficina_francaCar.php">
                    <div class="card mb-3 w-100">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="../imagens/franca_car.jpeg" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Oficina França Car</h5>
                                    <p class="card-text"> </p>
                                    <button id="btn" type="button" class="btn btn-primary btn-sm mt-1" disabled>Freios</button>
